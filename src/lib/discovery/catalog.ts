...
export const PROJECT_CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    altPaths: ["C:\\Projects\\Project Command\\AI-COMMAND-CENTER"],
    ...
    status: "active",
    priority: "P0",
    description: "Jeff Mission Control — Easy Mode dashboard, verify build, gap/fix prompts, Command Center docs.",
